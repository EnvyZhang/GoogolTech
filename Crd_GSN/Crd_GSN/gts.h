...
GT_API GT_GetEcatSlaves(short *SlaveMotionCnt,short *SlaveIOCnt);
...
GT_API GT_EcatSDODownload(unsigned short slave_position,unsigned short index, unsigned char subindex,
	unsigned char *data,unsigned int data_size, unsigned int *abort_code);
GT_API GT_EcatSDOUpload(unsigned short slave_position,unsigned short index, unsigned char subindex,unsigned char *target,
	unsigned int target_size,unsigned int *result_size,unsigned int *abort_code);
...
GT_API GTN_GetEcatSlaves(short core,short *SlaveMotionCnt,short *SlaveIOCnt);
...
GT_API GT_RelateEcatSlaveToMcAuEncoderEx(short auenc,short ecatAxisIndex);
...
GT_API GTN_RelateEcatSlaveToMcAuEncoderEx(short core,short auenc,short ecatAxisIndex);
